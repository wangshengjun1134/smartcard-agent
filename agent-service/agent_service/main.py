...
from agent_service.api import agent, session, config, smartcard, events
from agent_service.utils.database import init_session_database
from agent_service.config.logging import setup_logging
...
async def lifespan(app: FastAPI):
    ...
    from agent_service.tools.pcsc.client import PcscClient
    from agent_service.agents.tools.builtin import set_runtime_context
    ...
    from agent_service.api.events import emit_apdu_event
    ...
    from agent_service.skills.registry_extension import discover_and_register_skills
