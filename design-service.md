...
| `finalize_node` | 生成最终响应 | `state` | `response`, `summary` |
      ...
      5 │    ▼                                                                                 │
      6 │  ┌─────────────┐                                                                    │
      7 │  │   intent    │  分类意图: KNOWLEDGE_ONLY / REQUIRES_CARD / REQUIRES_APDU / ...     │
      8 │  └─────────────┘                                                                    │
      9 │    │                                                                                 │
     10 │    ▼                                                                                 │
     11 │  ┌─────────────┐                                                                    │
     12 │  │   planner   │  确定目标: read_imsi / read_iccid / discover_card / knowledge_query │
     13 │  └─────────────┘                                                                    │
     14 │    │                                                                                 │
     15 │    │ [所有 goal → think]                                                             │
     16 │    ▼                                                                                 │
     17 │  ┌─────────────┐     ┌──────────────┐     ┌───────────────┐                         │
     18 │  │    think    │ ──▶ │ skill_selector│ ──▶ │ skill_runtime │ ──┐                     │
     19 │  └─────────────┘     └──────────────┘     └───────────────┘   │                     │
     20 │    ▲                                            │              │                     │
     21 │    │                                            ▼              │                     │
     22 │    │                                      ┌───────────┐        │                     │
